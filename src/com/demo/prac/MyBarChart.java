...
/* The below code copied from the text book-
...
public class MyBarChart extends Application {
    ...
    public void start(Stage stage) {
        ...
        BarChart<String, Double> chart = loadMyRainData();// function to load the data
//        BorderPane root = new BorderPane(canvasHolder);
        BorderPane root = new BorderPane(chart);// instead of canvasHolder,we put chart
